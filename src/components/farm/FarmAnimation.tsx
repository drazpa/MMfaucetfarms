      ...
      >
        ...
        <g transform="translate(0, 50)">
          ...
          <g className="heart-pulse">
            ...
            {/* Leaves */}
            <path
              d="M100 145 C90 135, 85 140, 90 150 C85 140, 90 135, 100 145"
              fill="#22c55e"
              className="particle-1"
            />
            <path
              d="M100 145 C110 135, 115 140, 110 150 C115 140, 110 135, 100 145"
              fill="#22c55e"
          ...
          {/* Growing Plants */}
          {[...Array(4)].map((_, i) => (
            <g key={i} transform={`translate(${70 + i * 20}, 160)`}>
              <path
                d={`M0 0 C-5 -10 -10 -5 0 -15 C10 -5 5 -10 0 0`}
                fill="#22c55e"
                className={`particle-${i + 3}`}
              />
              <path
                d="M0 0 L0 15"
                stroke="#22c55e"
                strokeWidth="2"
                className={`particle-${i + 7}`}
              />
            </g>
          ))}
